...
//	prec = 30 * 3.32192809488736 + 4800;
//	intlim = 300;
	prec = 30 * 3.32192809488736 + 5600;
	intlim = 300;
	...
	arb_set_si(res, -701);
	if ((sw < 0) || (sw > 1) || (numthreads < 1) || (arb_ge(a, res)))
    {
        result = EXIT_FAILURE;
        goto finish;
    }
...
finish:
    ...
    "into the orthogonal Bessel y-polynomials as described in the paper:\n"
    ...
    "-> 'a' is the required parameter that needs to be a non-integer smaller than -2*300-1  \n"
