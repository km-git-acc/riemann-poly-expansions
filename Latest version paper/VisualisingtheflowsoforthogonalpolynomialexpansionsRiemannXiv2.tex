...
\begin{align}
  ...
  -n\,y(x) &\verifiedeq x\,y''(x)+(\alpha+1-x)\,y'(x) \label{lagPDE}\\
  X^{\mathcal{L}\,(d)}_r(t;a)\left[F(t)\right] &\verifiedeq \frac{a}{(a)_{d+1}}\,\sum_{n=0}^\infty \gamma_n(a)\,(-n)_d\,{}_1F_1\left(d-n, a+d+1,t\right)\,\exp(-nr) \\ 
  \gamma_n(a) &\verifiedeq f_n(a)\int_{0^+}^{\infty} F(x)\,w(x,a)\,{}_1F_1\left(-n, a+1,x\right)\,\mathrm{d}x \label{lagflow}\\
