...
\begin{table}[H]
  \begin{center}
    ...
    \begin{tabular}{l|l|c|} 
      ...
      $p_{2n}\left(t;a,b,a,b\right)$ & $\displaystyle \int_{-\infty}^{\infty} \Phi(x)\,\tanh\,\left(\frac{x}{2}\right)^n\,\,\,\frac{\textrm{e}^{a\,x}}{(\textrm{e}^{x}+1)^{2a}}\,hg1_n(x,a,b)\,\mathrm{d}x$  &$\Xi(t)$ \\                  
      ...
      $S_{n}\left(t^2;a,b,\frac12\right)$ & $\displaystyle \int_{-\infty}^{\infty} \Phi(x)\,\tanh\,\left(\frac{x}{2}\right)^{2n}\,\frac{\textrm{e}^{a\,x}}{(\textrm{e}^x+1)^{2a}}\,hg2_n(x,a,b) \,\mathrm{d}x $  &$\Xi(t)$ \\
      $W_n\left(t^2;a,b,\frac12,0\right)$ & $\displaystyle \int_{-\infty}^{\infty} \Phi(x)\,\tanh\left(\frac{x}{2}\right)^{2n}\,\frac{\mathrm{e}^{ax}}{(\mathrm{e}^x+1)^{2a}}\,hg3_n(x,a,b)\,\mathrm{d}x$ &$\Xi(t)$ \\
